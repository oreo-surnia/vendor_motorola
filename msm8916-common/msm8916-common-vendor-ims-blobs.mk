...
PRODUCT_COPY_FILES += \
    ...
    vendor/motorola/msm8916-common/proprietary/vendor/etc/permissions/ims.xml:vendor/etc/permissions/ims.xml \
    vendor/motorola/msm8916-common/proprietary/vendor/etc/permissions/com.qualcomm.qti.imscmservice.xml:vendor/etc/permissions/com.qualcomm.qti.imscmservice.xml \
    vendor/motorola/msm8916-common/proprietary/vendor/etc/permissions/cneapiclient.xml:vendor/etc/permissions/cneapiclient.xml \
    vendor/motorola/msm8916-common/proprietary/vendor/etc/permissions/com.quicinc.cne.xml:vendor/etc/permissions/com.quicinc.cne.xml \
    vendor/motorola/msm8916-common/proprietary/vendor/etc/permissions/qti_permissions.xml:vendor/etc/permissions/qti_permissions.xml \
